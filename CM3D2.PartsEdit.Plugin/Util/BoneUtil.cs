...
internal static class BoneUtil {
    public static bool IsBodyBone(string boneName) {
        return BodyBoneNameList.Contains(boneName);
    }
    ...
    static HashSet<string> BodyBoneNameList = new HashSet<string> {
        "Bip01",
        "Bip01 Head",
        "Bip01 L Calf",
        "Bip01 L Calf_SCL_",
    ...
    static HashSet<string> BodyBonePathList = new HashSet< string > {
        "Bip01",
        "Bip01/Bip01 Pelvis",
    ...
    static HashSet<string> AutoCalcBoneNameList = new HashSet<string> {
        "Foretwist_L",
        "Foretwist_R",
        "Foretwist1_L",
        "Foretwist1_R",
    ...
    static HashSet<string> AutoCalcBonePathList = new HashSet<string> {
        "Bip01/Bip01 Pelvis/Bip01 L Thigh/momotwist_L",
        "Bip01/Bip01 Pelvis/Bip01 L Thigh/momotwist_L/momoniku_L",
        "Bip01/Bip01 Pelvis/Bip01 L Thigh/momotwist_L/momotwist2_L",
        "Bip01/Bip01 Pelvis/Bip01 R Thigh/momotwist_R",
